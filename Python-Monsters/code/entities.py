...
class Entity(pygame.sprite.Sprite):
    def __init__(self, pos, frames, groups, facing_direction):
        ...
        self.hitbox = self.rect.inflate(-self.rect.width / 2 - 20, -83)
...
class Character(Entity):
    def __init__(self, pos, frames, groups, facing_direction, character_data, player, create_dialogue, collision_sprites, radius, nurse, notice_sound):
