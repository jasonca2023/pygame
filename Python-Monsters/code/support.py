...
def audio_importer(*path):
	...
	files['splash'].set_volume(0.1)
	files['scratch'].set_volume(0.2)
	files['overworld'].set_volume(0.8)
	files['notice'].set_volume(0.2)
	files['ice'].set_volume(0.1)
	files['green'].set_volume(0.1)
	files['fire'].set_volume(0.2)
	files['explosion'].set_volume(1.2)
	files['evolution'].set_volume(0.2)
	files['battle'].set_volume(0.5)
	return files
