TRAINER_DATA = {
	...
	'px': {
		'monsters': {0: ('Friolera', 25), 1: ('Gulfin', 20), 2: ('Atrox',50), 3: ('Finiette', 30)},
		'dialog': {
			'default': ['I love trees', 'and fights'], 
			'defeated': ['Good luck with the boss!']},
		'directions': ['down'],
	...
	'wx': {
		'monsters': {0: ('Friolera', 25), 1: ('Gulfin', 20), 2: ('Draem',24), 3: ('Finiette', 50)},
		'dialog': {
	...
	'fx': {
		'monsters': {0: ('Cindrill', 15), 1: ('Jacana', 60), 2: ('Draem',24), 3: ('Atrox', 30)},
		'dialog': {
...
MONSTER_DATA = {
	'Plumette': {
		...
		'abilities': {0: 'scratch', 5: 'spark', 20: 'splash'},
		'evolve': ('Ivieron', 15)},
	'Ivieron': {
	...
	'Cleaf': {
		...
		'abilities': {0: 'scratch', 5: 'heal', 15: 'fire'},
		'evolve': None},
	'Jacana': {
...
ATTACK_DATA = {
	...
	'heal':       {'target': 'player',   'amount': -1.2, 'cost': 20, 'element': 'plant',  'animation': 'green'},
	'battlecry':  {'target': 'player',   'amount': -1.4, 'cost': 30, 'element': 'normal', 'animation': 'green'},
	...
	'explosion':  {'target': 'opponent', 'amount': 3,    'cost': 70, 'element': 'fire',   'animation': 'explosion'},
	'annihilate': {'target': 'opponent', 'amount': 3,    'cost': 40, 'element': 'fire',   'animation': 'explosion'},
